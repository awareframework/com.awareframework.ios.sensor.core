...
let package = Package(name: "com.awareframework.ios.sensor.core",
                      platforms: [.iOS(.v13),],
                      products: [
                          .library(name: "com.awareframework.ios.sensor.core", 
                    ...
                    dependencies: [
                      ...
                      targets: [.target(name: "com.awareframework.ios.sensor.core",
                                        dependencies: [
